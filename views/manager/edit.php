    ...
    <div class="rounded-4" style="background-color:#d2fce4;">   
        ...
        <form class="mx-5" name="formEdit" id="formEdit" method="post" action="<?php echo DIRPAGE.'controllers/EventsControllers/ControllerEdit.php'; ?>">
            ...
            <div>
                ...
                <input class="form-control form-control-sm rounded-pill" type="text" name="title" id="title" value="<?php echo $events['title']; ?>">
            </div>

            <div>
                <label class="form-label m-0" for="description">DESCRIÇÃO: </label>    
                <input class="form-control form-control-sm rounded-pill" type="text" name="description" id="description" value="<?php echo $events['description']; ?>">
            </div>

            <div>
                <label class="form-label m-0" for="date">DATA: </label>    
                <input class="form-control form-control-sm rounded-pill" type="date" name="date" id="date" value="<?php echo $date->format("Y-m-d"); ?>">
            </div>

            <div>
                <label class="form-label m-0" for="time">COMEÇO: </label>    
                <input class="form-control form-control-sm rounded-pill" type="time" name="time" id="time" value="<?php echo $date->format("H:i"); ?>">
            </div>

            <div>
                <label class="form-label m-0" for="time">FIM: </label>    
                <input class="form-control form-control-sm rounded-pill" type="time" name="time" id="time" value="<?php echo $end->format("H:i"); ?>">
            </div>
